...
class startprojekt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "startprojekt")
        ...
        self._freq_range = Range(100, 2000, 1, 1000, 200)
        self._freq_win = RangeWidget(self._freq_range, self.set_freq, "'freq'", "dial", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=startprojekt, options=None):
